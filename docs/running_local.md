...
If you need account with funds you can use the [deposit script](https://github.com/JiamingSuper/polygon-zkevm-bridge/blob/develop/test/scripts/deposit/main.go)
to fund an account.
