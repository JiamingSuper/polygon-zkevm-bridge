...
LDFLAGS += -X 'github.com/JiamingSuper/polygon-zkevm-bridge.Version=$(VERSION)'
LDFLAGS += -X 'github.com/JiamingSuper/polygon-zkevm-bridge.GitRev=$(GITREV)'
LDFLAGS += -X 'github.com/JiamingSuper/polygon-zkevm-bridge.GitBranch=$(GITBRANCH)'
LDFLAGS += -X 'github.com/JiamingSuper/polygon-zkevm-bridge.BuildDate=$(DATE)'
